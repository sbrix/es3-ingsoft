...
public class FrameAggiungiUtenteTable extends FrameAggiungiClienteTable {
	 ...
	 * Create the frame.
	 */
	public FrameAggiungiUtenteTable(final Agenzia ag_, final JPanel panel_,ModelUtenti model_) {
