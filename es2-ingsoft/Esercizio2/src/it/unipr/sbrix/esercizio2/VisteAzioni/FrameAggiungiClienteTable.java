...
public class FrameAggiungiClienteTable extends JFrame implements ActionListener {
	...
	public FrameAggiungiClienteTable(final Agenzia ag, final JPanel panel_, final ModelUtenti model_) {
		agenzia = ag;
		panel = panel_;
		model=model_;
