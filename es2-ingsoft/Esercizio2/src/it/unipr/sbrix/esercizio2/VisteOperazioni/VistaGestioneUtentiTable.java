...
public class VistaGestioneUtentiTable extends JPanel implements ActionListener{
	 ...
	 * Create the panel.
	 */
	public VistaGestioneUtentiTable(Agenzia agenzia) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==btnAggiungi){
			// aggiunta di un utente alla lista utenti
						JFrame frameAggiungiUser = new FrameAggiungiUtenteTable(this.ag,
